...
if (isset($_POST['submit'])) {
    ...
    $sql = 'update turma set nome="' . $nome . '", data_periodo_inicial="' . $data_periodo_inicial . '", 
    data_periodo_final="' . $data_periodo_final . '", horario="' . $horario . '", natureza="' . $natureza . '",
    cargahoraria="' . $cargahoraria . '", idcurso="' . $idcurso . '", idinstrutor="' . $idinstrutor . '" where id=' . $id;
    $result = mysqli_query($con, $sql);
    if ($result) {
...
<body style="background-image: url(../img/fundo.jpg); background-size: cover;">
    ...
    <center>
        <div class="container-fluid" style="width: 40%;">
            <form method="POST">
                <div class="jumbotron">
                    <h1 style="color: rgb(2, 84, 160); ">Alterar Turma</h1>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="date" id="inpselect" name="data_periodo_inicial"
                                value="<?php echo $data_periodo_inicial ?>">
                            <br><br>
                            <p class="pselect">Data Final</p>
                            <input type="date" id="inpselect" name="data_periodo_final"
                                value="<?php echo $data_periodo_final ?>">
                        </div>


                        <div class="col">
                            <p class="pselect">Horário</p>
                            <input type="text" id="inpselect" name="horario" value="<?php echo $horario ?>">
                            <br><br>
                            <p class="pselect">Carga Horária</p>
                            <input type="text" id="inpselect" name="cargahoraria" value="<?php echo $cargahoraria ?>">
                            <br><br>
