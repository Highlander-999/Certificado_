...
if (isset($_POST['submit'])) {
    //    verificar se existe turma no curso
    $sql = 'select * from turma where idcurso=' . $id;
    $result = mysqli_query($con, $sql);
    if ($result) {
        echo '<script>alert("Exclusão inválida. Existe turma no curso.")</script>';
    } else {
        $sql = 'delete from curso where id=' . $id;
        $result = mysqli_query($con, $sql);
        if ($result) {
        ...
        <div class="container">
            ...
            <form method="POST">
                ...
                <div class="jumbotron" style="width: fit-content;">
                    ...
                    <h1 style="color: rgb( 2, 84, 160); ">Excluir Curso</h1>
                            ...
                            <div class="col">
                                ...
                                <a href="curselect.php">
                                    <button type="button" class="btn btn-primary"
                                        style="width: 120px;font-size: 25px;  color: white; background-color: rgb(2, 84, 160);">Voltar</button>
                                </a>
