...
if (isset($_POST['submit'])) {
    ...
    $master = $_POST['master'];
    $senha = $_POST['senha'];
    $sql = 'insert into usuario (nome, email, master, senha) values
    ("' . $nome . '","' . $email . '","' . $master . '","' . $senha . '")';
        ...
        <div class="container">
            ...
            <form method="POST">
                ...
                <div class="jumbotron" style="width: fit-content;">
                    ...
                    <h1 style="color: rgb( 2, 84, 160); ">Incluir Usuário</h1>


                    <div class="row">
                        <div class="col">
                            <p class="pselect">Nome</p>
                            <input type="text" id="inpselect" name="nome">
                            <br><br>
                            <p class="pselect">Email</p>
                            <input type="email" id="inpselect" name="email">
                        </div>
                        <div class="col">
                            <p class="pselect">
                                Master
                            </p>
                            <select name="master" id="selcurso" style="float: left;width: 25%;">
                            ...
                            <input type="text" id="inpselect" style="width: 300px;" name="senha">
                        </div>
                    </div>
