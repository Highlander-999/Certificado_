...
include('../connect.php');
$sql = 'select id, nome from instrutor order by 1';
$pesqnome = '';
if (isset($_POST['submit'])) {
    $pesqnome = $_POST['pesqnome'];
    $sql = "select * from instrutor where nome like '%$pesqnome%' order by 1";
}
        ...
        <div class="container">
            ...
            <div class="jumbotron">
                ...
                <form method="POST">
                    ...
                    <h1 style="color: rgb(2, 84, 160); ">Consultar Instrutor</h1>
                    ...
                    if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td style='width:30%'>
                                ...
                                <td style='font-size: 20px;'>" . $row['nome'] . "</td>
                                <td style='width:30%'>
                                <a href='insupdate.php?updateid={$row['id']}'
                                <button type='button' class='btn btn-success'>
                                Alterar
                                </button>
                                </a>
                                
                                <a href='insdelete.php?deleteid={$row['id']}'
