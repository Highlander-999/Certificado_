...
include('../connect.php');
$sql = 'select id, nome, email, master from usuario order by 1';
$pesqnome = '';
if (isset($_POST['submit'])) {
    $pesqnome = $_POST['pesqnome'];
    $sql = "select * from usuario where nome like '%$pesqnome%' order by 1";
}
                ...
                <table class="table table-bordered" style="background-color: white; text-align: center;">
                    <thead style="background-color: rgb(2, 84, 160);">
                        <tr>
                            ...
                            <th scope="col" style="color: white;">Administrador</th>
                        ...
                        if ($result) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                    ...
                                    <td style='font-size: 20px;width:10%;''>" . $row['master'] . "</td>
                                    <td style='width:25%;'>
